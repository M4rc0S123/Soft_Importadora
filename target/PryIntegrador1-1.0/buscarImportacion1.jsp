            ...
            <table class="importacion-table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="actions">
                            <a href="DetalleImportaServlet1?id_importacion=<%= imp.getId_importacion()%>" class="action-icon" title="Ver Detalle">🔍</a>
                            <a href="SeguimientoServlet1?accion=ver&idImportacion=<%= imp.getId_importacion()%>" class="action-icon" title="Ver Seguimiento">📋</a>
