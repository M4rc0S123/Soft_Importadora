            ...
            <div class="header-importacion">
                ...
                <table class="importacion-table">
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="empleado?action=edit&id=<%= e.getId_empleado()%>">
                                <img src="img/icono_editar.png" alt="Modificar" width="20" height="20"/></a>
                            <a href="empleado?action=delete&id=<%= e.getId_empleado()%>"
                               onclick="return confirm('¿Estás seguro de que deseas eliminar a <%= e.getNombre()%> <%= e.getApellido()%>?')">
