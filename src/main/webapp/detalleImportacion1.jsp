...
<div class="main-content">
        ...
        <c:if test="${not empty importacion}">
            ...
            <a href="producto1" class="btn">Ir a Productos</a>
            <a href="buscarImportacion1.jsp" class="btn">Volver a Importaciones</a>
        ...
        <c:if test="${empty importacion and empty mensajeError}">
            ...
            <a href="buscarImportacion1.jsp" class="btn">Ver Importaciones</a>
        </c:if>
    </div>
</body>
</html>
