...
@WebServlet("/DetalleImportaServlet1") // Asegúrate de que esta URL coincida con el enlace
public class DetalleImportaServlet1 extends HttpServlet {
    ...
    try {
        ...
        request.getRequestDispatcher("detalleImportacion1.jsp").forward(request, response);
