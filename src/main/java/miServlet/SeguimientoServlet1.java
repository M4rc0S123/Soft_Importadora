...
@WebServlet("/SeguimientoServlet1")
public class SeguimientoServlet1 extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) 
        ...
        if (accion != null && idImportacionStr != null && accion.equals("ver")) {
            ...
            if (importacion != null && seguimientos != null && !seguimientos.isEmpty()) {
                ...
                request.getRequestDispatcher("estadoimpor1.jsp").forward(request, response);
        ...
        if ("registrar".equals(accion)) {
            try {
                ...
                if (registrado) {
                    ...
                    response.sendRedirect(contextPath + "/SeguimientoServlet1?accion=ver&idImportacion=" + idImportacion + "&mensaje=Registro+exitoso");
                } else {
