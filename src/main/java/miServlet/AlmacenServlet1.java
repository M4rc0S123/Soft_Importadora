...
@WebServlet("/AlmacenServlet1")
public class AlmacenServlet1 extends HttpServlet {
    ...
    // Hacer el forward
    RequestDispatcher rd = request.getRequestDispatcher("almacen1.jsp");
    ...
    return;
                ...
                case "registrar":
                    if (request.getMethod().equals("POST")) {
                        ...
                        response.sendRedirect("AlmacenServlet1?action=listar");
                    }
                    break;
...
case "nuevo":
    ...
    request.getRequestDispatcher("formAlmacen1.jsp").forward(request, response);
    break;
